...
### "Bất thường" ở đây nghĩa là gì? (định nghĩa cốt lõi — phải nói thật rõ)

Cần nói rõ ngay từ đầu để tránh hiểu nhầm: **"bất thường" KHÔNG có nghĩa là "đã chứng minh gian lận".** Nó nghĩa là:

> Một phiên truy cập có **mẫu hành vi lệch khỏi cách một người mua sắm bình thường thường làm** — lệch đến mức đáng nghi và đáng được gắn cờ để xem lại.

Người mua bình thường thường: xem vài sản phẩm với nhịp độ tay người, thỉnh thoảng thêm giỏ, đôi khi mua, hoạt động vào giờ thức. Một phiên bị coi là bất thường khi nó **phá vỡ mẫu đó** theo một trong các kiểu sau. Nhóm bất thường chia thành 3 họ chính:

1. **Dấu hiệu máy/tự động (bot):** thao tác quá nhanh, quét quá nhiều, hoạt động lệch giờ — không giống tay người bấm.
...
**Ý tưởng sinh nhãn: hệ thống 12 luật nghiệp vụ (business rules).** Vì không có nhãn thật, nhóm định nghĩa "bất thường" thành các điều kiện đo được cụ thể. Mỗi luật là một định nghĩa rõ ràng cho một kiểu bất thường:

| Mã | Loại | Hiểu nôm na | Ngưỡng cụ thể (đã dùng) |
|---|---|---|---|
| BR01 | Bot scraper | Quét trang như máy, không như người | ≥ 12 event/phiên **hoặc** ≥ 8 thao tác/phút |
| BR02 | Ghost buyer | Mua mà chưa từng bỏ vào giỏ | có mua & 0 lần thêm giỏ |
| BR03 | Click fraud | Xem nhiều nhưng tuyệt nhiên không mua/thêm giỏ | ≥ 6 lượt xem, 0 thêm giỏ, 0 mua |
| BR04 | Rapid-fire | Bấm liên tiếp nhanh bất thường | có chuỗi thao tác cực ngắn hoặc ≥ 20% thao tác là "bắn liên thanh" |
| BR05 | Night crawler | Hoạt động chủ yếu lúc nửa đêm | ≥ 75% hoạt động trong 0h–5h (và ≥ 4 event) |
| BR06 | Item hoarding | Nhồi cùng 1 món vào giỏ | thêm cùng 1 item vào giỏ > 1 lần |
| BR07 | Session bomb | Mở/xem hàng loạt sản phẩm khác nhau | ≥ 12 item khác nhau trong 1 phiên |
| BR08 | Sequence violation | Sai thứ tự: mua trước khi xem/thêm giỏ | giao dịch xuất hiện trước view/addtocart của cùng item |
| BR09 | Transaction burst | Mua dồn dập trong 1 phiên | ≥ 3 giao dịch/phiên |
| BR10 | Cart abandonment | Chất đầy giỏ rồi bỏ, không mua | ≥ 10 lần thêm giỏ, 0 giao dịch |
| BR11 | Repeated view spam | Xem đi xem lại 1 món | xem cùng 1 item ≥ 20 lần |
| BR12 | Category scanning | Lùng sục khắp các danh mục | ≥ 20 danh mục khác nhau trong 1 phiên |

Đây là **multi-label**: một phiên có thể dính nhiều luật cùng lúc. **Một phiên được coi là bất thường nếu vi phạm ít nhất một luật.** Tổng cộng có 61.849 phiên bất thường (3,51%).

**Ví dụ minh họa cho dễ hình dung:** một phiên xem 40 sản phẩm trong 2 phút, lúc 3 giờ sáng, không thêm giỏ, không mua → dính BR01 (bot), BR03 (click fraud), BR05 (night crawler) cùng lúc. Đây rõ ràng không phải người mua hàng thật → bị gắn cờ bất thường.
